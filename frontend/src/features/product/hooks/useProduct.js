...
export const useProduct = () => {
    ...
    return { handleCreateProduct, handleGetSellerProducts, handleGetProductById, handleGetAllProducts, handleAddVariants, handleUpdateProduct, handleSearchProducts }
}